...
class TAdv extends \yii\db\ActiveRecord
{
    ...
    public function getTermList()
    {
        $items = [];
        $items[0] = '1 день';
        $items[1] = '3 дня (скидка 5%)';
        $items[2] = '1 неделя (скидка 10%)';
        $items[3] = '2 недели (скидка 15%)';
        $items[4] = '3 недели (скидка 20%)';
        $items[5] = '1 месяц (скидка 25%)';
        $items[6] = '2 месяца (скидка 30%)';
        $items[7] = '3 месяца (скидка 35%)';
        $items[8] = '4 месяца (скидка 40%)';
        $items[9] = '5 месяцев (скидка 45%)';
        $items[10] = '6 месяцев (скидка 50%)';
        return $items;
    }
