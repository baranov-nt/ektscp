...
class TTerminal extends \yii\db\ActiveRecord
{
    ...
    {
        return [
		[['city', 'passability', 'comments', 'admin_phone', 'admin_name', 'place', 'category_place', 'admin_email'], 'required', 'on' => 'default'],
            [['city', 'comments', 'admin_phone', 'admin_name', 'place', 'category_place'], 'required', 'on' => 'complite'],
            ...
            [['admin_email'], 'email'],
            [['city', 'street'], 'safe'],
            [['street', 'house'], 'required', 'on' => 'default'],
            ['internet_price',  'validateInternetPrice']
        ];
    }

    public function validateInternetPrice() {
        dd($this);
    }
